        ...
        <aside>
            ...
            <nav>
                <ul>
                    ...
                    <li class="active">
                        <img class="imagem" src="${pageContext.request.contextPath}/assets/crud/usuarios_azul.svg"
                             alt="icone usuarios">
                            ...
                            <div class="filtragem">
                                <label>
                                    ...
                                    <select id="campoFiltro" name="campo_filtro" onchange="tipoCampoUsuario()">
                                        ...
                                        <option value="data_nascimento" data-type="date-nascimento">Data de Nascimento
                                        </option>
