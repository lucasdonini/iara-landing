      ...
      <div id="tela_principal">
        <div id="cabecalho">
          ...
          <div id="botoes">
            ...
            <a id="cadastrar" href="${pageContext.request.contextPath}/usuarios?action=create">Cadastrar
            </a>
          </div>

        </div>

        <div id="tabela_usuarios" class="tabela-container">
          <table border="0">
            <tr>
              <th>ID</th>
              <th>Nome</th>
