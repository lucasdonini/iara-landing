    ...
    <div id="sidebar">
        <aside>
            ...
            <nav>
                <ul>
                    <li>
                        <img class="imagem" src="${pageContext.request.contextPath}/assets/crud/home.svg"
                             alt="icone home">
                        <a href="${pageContext.request.contextPath}/area-restrita/index.jsp">Página inicial</a>
                    </li>
                    <li>
                        <img class="imagem" src="${pageContext.request.contextPath}/assets/crud/usuario.svg"
                             alt="icone usuarios">
                    ...
                    <li>
                        <img class="imagem" src="${pageContext.request.contextPath}/assets/crud/planos.svg"
                             alt="icone planos">
                        <a href="${pageContext.request.contextPath}/area-restrita/planos">Planos</a>
                    </li>
                    <li>
                        <img class="imagem" src="${pageContext.request.contextPath}/assets/crud/fabricas.svg"
                             alt="icone fábricas">
                        <a href="${pageContext.request.contextPath}/area-restrita/fabricas">Fábricas</a>
                    </li>
                    <li class="active">
                        <img class="imagem" src="${pageContext.request.contextPath}/assets/crud/pagamento_azul.svg"
                        ...
                        <form action="${pageContext.request.contextPath}/area-restrita/pagamentos" method="get">
                            ...
                            <div class="filtragem">
                                <label>
                                    ...
                                    <select id="campoFiltro" name="campo_filtro" onchange="tipoCampoPagamento()">
                                        ...
                                        <option value="data_pagamento" data-type="datetime-local">Data Pagamento
                                        </option>
                            ...
                            <div class="filtragem" style="display: none">
                                ...
                                <select name="valor_plano" id="valorPlano">
                                    ...
                                    <option value=<%=plano%>><%=planos.get(plano)%>
                                    </option>
                                    <% } %>
                                </select>
                            </div>
                            ...
                            <div class="filtragem" style="display: none">
                                ...
                                <select name="valor_fabrica" id="valorFabrica">
                                    ...
                                    <option value=<%=fabrica%>><%=fabricas.get(fabrica)%>
                                    </option>
                                    <% } %>
                                </select>
                            </div>
