...
<head>
    ...
    <link rel="icon" href="${pageContext.request.contextPath}/assets/IARA - Imagens Landing/Geral/Mascote IARA.png">
...
<main class="login-container">
    ...
    <div class="left-side">
        <img src="${pageContext.request.contextPath}/assets/Cadastro/iara-direita_1-removebg-preview 1.png" alt="Mascote IARA" class="mascote">
    </div>
